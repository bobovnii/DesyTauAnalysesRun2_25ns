...
//#include "/nfs/dust/cms/user/bobovnii/CMSSW_8_0_12/src/DesyTauAnalyses/NTupleMaker/interface/Basic_Mt2_332_Calculator.h"
//#include "/nfs/dust/cms/user/bobovnii/CMSSW_8_0_12/src/DesyTauAnalyses/NTupleMaker/interface/mTBound.h"
//#include "/nfs/dust/cms/user/bobovnii/CMSSW_8_0_12/src/DesyTauAnalyses/NTupleMaker/interface/TMctLib.h"
//#include "/nfs/dust/cms/user/bobovnii/CMSSW_8_0_12/src/DesyTauAnalyses/NTupleMaker/interface/mctlib.h"
#include "TTree.h"
#include <iostream>
...
//for(int cj = 0; cj < CutNer; cj++)
  //  {
      ...
      htau_dxy[cj]->Sumw2();
      htau2_dxy[cj] = new TH1D ("htau2_dxy_"+nCut,"htau2_dxy "+cutName,20,-.2,.2);      
      htau2_dxy[cj]->Sumw2();

      
      htau_dz[cj] = new TH1D ("tau_dz_"+nCut,"tau_dz "+cutName,20,-.2,.2);
      htau_dz[cj]->Sumw2();
      htau2_dz[cj] = new TH1D ("htau2_dz_"+nCut,"htau2_dz "+cutName,20,-.2,.2);
      htau2_dz[cj]->Sumw2();
      ...
      hnTau2[cj] = new TH1D ("nTau2_"+nCut,"nTau2 "+cutName,10,-0.5,9.5);
      hnTau2[cj]->Sumw2();
      hTaupt2[cj] = new TH1D ("TaupT2_"+nCut,"Tau2 pT "+cutName,25,0,500);
      hTaupt2[cj]->Sumw2();
      hTaueta2[cj] = new TH1D ("Taueta2_"+nCut,"Tau2 eta "+cutName,40,-4,4);
      hTaueta2[cj]->Sumw2();
      ...
      hIsoTau[cj]->Sumw2();
      hIsoTau2[cj] = new TH1D ("IsoTau2_"+nCut,"Tau2 Iso "+cutName,100,0,5);
      hIsoTau2[cj]->Sumw2();
      ...
      hdPhiTauMET2[cj] = new TH1D("dPhiTauMET2_"+nCut,"dPhiTauMET2 "+cutName,64,0.0,3.2);
      hdPhiTauMET2[cj]->Sumw2();
      ...
      hMt2tautau[cj] = new TH1D ("Mt2tautau_"+nCut,"Mt2tautau "+cutName,25,0,500);
      hMt2tautau[cj]->Sumw2();
      hMt2lestertautau[cj] = new TH1D ("Mt2lestertautau_"+nCut,"Mt2lestertautau "+cutName,30,0,600);
      hMt2lestertautau[cj]->Sumw2();
 
      hMCTtautau[cj] = new TH1D ("MCTtautau_"+nCut,"MCTtautau "+cutName,25,0,500);
      hMCTtautau[cj]->Sumw2();
      hMCTxtautau[cj] = new TH1D ("MCTxtautau_"+nCut,"MCTxtautau "+cutName,25,0,500);
      hMCTxtautau[cj]->Sumw2();
      hMCTytautau[cj] = new TH1D ("MCTytautau_"+nCut,"MCTytautau "+cutName,25,0,500);
      hMCTytautau[cj]->Sumw2();
      
      hMCTbtautau[cj] = new TH1D ("MCTbtautau_"+nCut,"MCTbtautau "+cutName,25,0,500);
